...
class HyperbandOracle(oracle_module.Oracle):
    ...
    def __init__(
        ...
        if first_round_tot != None: self.first_round_tot = first_round_tot
        else: self.first_round_tot = max_epochs
    ...
    def _get_size(self, bracket_num, round_num):
        ...
        total_bracket_num = self._get_num_brackets()
        bracket_beg_size = self.first_round_tot / self.factor ** (total_bracket_num - bracket_num - 1)
        return math.ceil(bracket_beg_size / self.factor ** (round_num))
    ...
    def __init__(
        ...
        **kwargs
        ...
        oracle = HyperbandOracle(
            ...
            factor=factor,
            first_round_tot=first_round_tot,
